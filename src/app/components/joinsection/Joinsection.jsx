  ...
  return (
    <section className="w-full bg-white py-20 font-[Outfit]">
      <div className="Mycontainer mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 max-w-xl w-full text-left">
          <div className="inline-block mb-5 text-[17px] sm:text-[19px] leading-[30px] sm:leading-[34px] px-4 py-1.5 rounded-tl-[15px] rounded-br-[15px] bg-gradient-to-r from-[#2b72ff] to-[#04bdd1] text-white font-medium">
            {joinus.toptext}
          </div>

          <h2 className="text-[32px] sm:text-[40px] lg:text-[46px] leading-[42px] sm:leading-[50px] lg:leading-[55px] font-medium text-[#021228] mb-8">
            {joinus.heading}
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            ...
            <p className="text-[22px] sm:text-[26px] leading-[30px] sm:leading-[33px] font-medium text-[#021228]">
              <span className="text-[#2b72ff] font-medium">{joinus.text1}</span>{" "}
              {joinus.text2}
            </p>
          </div>
        </div>

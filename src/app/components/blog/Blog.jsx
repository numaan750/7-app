    ...
    <section className="bg-white py-20 font-[Outfit]">
      <div className="Mycontainer mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 xl:gap-14 max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center sm:items-stretch bg-white shadow-2xl overflow-hidden transition-transform duration-500">
            <div className="relative w-full sm:w-1/2 h-[230px] sm:h-[280px] lg:h-[320px] overflow-hidden rounded-br-[60px] group">
            ...
            <div className="flex-1 p-6 lg:p-8 text-left flex flex-col justify-center">
